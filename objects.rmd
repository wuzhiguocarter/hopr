...
```{r fig:coercion, echo = FALSE, fig.cap = "R always uses the same rules to coerce data to a single type. If character strings are present, everything will be coerced to a character string. Otherwise, logicals are coerced to numerics."}
...
```{r fig:data-frame, echo = FALSE, fig.cap = "Data frames store data as a sequence of columns. Each column can be a different data type. Every column in a data frame must be the same length."}
...
```{r fig:import, echo = FALSE, fig.cap = "You can import data from plain-text files with RStudio's Import Dataset."}
...
```{r fig:wizard, echo = FALSE, fig.cap = "RStudio's import wizard."}
...
```{r fig:view, echo = FALSE, fig.cap = "When you import a data set, RStudio will save the data to a data frame and then display the data frame in a View tab. You can open any data frame in a View tab at any time with the View function."}
...
```{r fig:structures, echo = FALSE, fig.cap = "R's most common data structures are vectors, matrices, arrays, lists, and data frames."}
