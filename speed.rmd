...
```{r fig:abs, echo = FALSE, fig.cap = "`abs_loop` uses a for loop to sift data into one of two cases: negative numbers and nonnegative numbers."}
...
```{r fig:assignment, echo = FALSE, fig.cap = "Use logical subsetting to modify groups of values in place. R's arithmetic and assignment operators are vectorized, which lets you manipulate and update multiple values at once."}
...
```{r fig:change, echo = FALSE, fig.cap = "`change_many` does something different for each of seven cases."}
...
```{r fig:venn, echo = FALSE, fig.cap = "The three core skill sets of data science: computer programming, data comprehension, and scientific reasoning."}
