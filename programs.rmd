...
```{r fig:subdivide1, echo = FALSE, fig.cap = "The play function uses a series of steps."}
...
```{r fig:subdivide2, echo = FALSE, fig.cap = "The score function must distinguish between parallel cases."}
knitr::include_graphics("images/hopr_0702.png")
```

```{r fig:subdivide3, echo = FALSE, fig.cap = "The complete slot machine simulation will involve subtasks that are arranged both in series and in parallel."}
...
```{r fig:subdivide4, echo = FALSE, fig.cap = "score can navigate three cases with two if else decisions. We can also break some of our tasks into two steps."}
